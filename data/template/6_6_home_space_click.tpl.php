...
<img src="<?php echo STATICURL;?>image/click/<?php echo $value['icon'];?>" alt="" /><br />
                <?php if($value['clicknum']) { ?><em style="margin-right: 3px; color: red;"><?php echo $value['clicknum'];?></em>人点赞<?php } ?><?php echo $value['name'];?>
</a>
</td>
<?php } ?>
</tr>
