...
0
|| checktplrefresh('data/diy/./template/elec_201706_bt//portal/view_1.htm', './template/elec_201706_bt/portal/portal_comment.htm', 1539877006, 'diy', './data/template/6_diy_portal_view_1.tpl.php', 'data/diy/./template/elec_201706_bt/', 'portal/view_1')
|| checktplrefresh('data/diy/./template/elec_201706_bt//portal/view_1.htm', './template/default/common/seccheck.htm', 1539877006, 'diy', './data/template/6_diy_portal_view_1.tpl.php', 'data/diy/./template/elec_201706_bt/', 'portal/view_1')
;
block_get('144,145');?><?php include template('common/header'); ?><link rel="stylesheet" type="text/css" href="template/elec_201706_bt/style/css/pindao.css" />
    ...
    <div class="Framebox cl" style="float: right; width: 800px; padding: 0 0 10px 0;">
      <div class="middle_info cl">
        <div class="bm vw" style="background: none;"> 
          ...
          <!--[diy=diycontentrelate]--><div id="diycontentrelate" class="area"><div id="framevBb8WR" class="frame move-span cl frame-1"><div id="framevBb8WR_left" class="column frame-1-c"><div id="framevBb8WR_left_temp" class="move-span temp"></div><?php block_display('144');?></div></div></div><!--[/diy]--> 
        </div>
      </div>
...
<?php } ?>
    <!--[diy=diy2]--><div id="diy2" class="area"><div id="framePAz4fa" class="frame move-span cl frame-1"><div id="framePAz4fa_left" class="column frame-1-c"><div id="framePAz4fa_left_temp" class="move-span temp"></div><?php block_display('145');?></div></div></div><!--[/diy]-->
