...
0
|| checktplrefresh('data/diy/./template/elec_201706_bt//forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1539884830, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/elec_201706_bt/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/elec_201706_bt//forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1539884830, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/elec_201706_bt/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/elec_201706_bt//forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1539884830, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/elec_201706_bt/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/elec_201706_bt//forum/forumdisplay.htm', './template/elec_201706_bt/forum/forumdisplay_list.htm', 1539884830, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/elec_201706_bt/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/elec_201706_bt//forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1539884830, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/elec_201706_bt/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/elec_201706_bt//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1539884830, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/elec_201706_bt/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/elec_201706_bt//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1539884830, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/elec_201706_bt/', 'forum/forumdisplay')
;
block_get('149,150');?><?php include template('common/header'); if($_G['forum']['ismoderator']) { ?>
...
<?php } ?>
<div class="mn" style="float: left; width: 860px;">
<div class="bm bml pbn">
<?php if($_G['forum']['banner'] && !$subforumonly) { ?><img src="<?php echo $_G['forum']['banner'];?>" alt="<?php echo $_G['forum']['name'];?>" style="max-width: 100%; margin-bottom: 10px;"><?php } ?>
<div class="cl">
...
<div id="forum_rules_<?php echo $_G['fid'];?>" style="<?php echo $collapse['forum_rules'];?>; font-size: 14px; color: #333333; margin-bottom: 20px;">
<div class="ptn">本版规则： <em style="color: #666666;"><?php echo $_G['forum']['rules'];?></em></div>
</div>
<?php } ?>
            </div>
...
<img src="template/elec_201706_bt/style/elecom_icon/image_s.gif" alt="attach_img" title="图片附件" align="absmiddle" />
<?php } elseif($thread['attachment'] == 1) { ?>
<img src="template/elec_201706_bt/style/elecom_icon/common.gif" alt="attachment" title="附件" align="absmiddle" />
...
<img src="template/elec_201706_bt/style/elecom_icon/digest_<?php echo $thread['digest'];?>.png" align="absmiddle" alt="digest" title="精华 <?php echo $thread['digest'];?>" />
<?php } if($thread['displayorder'] == 0) { if($thread['recommendicon'] && $filter != 'recommend') { ?>
<img src="template/elec_201706_bt/style/elecom_icon/recommend_<?php echo $thread['recommendicon'];?>.gif" align="absmiddle" alt="recommend" title="评价指数 <?php echo $thread['recommends'];?>" />
<?php } if($thread['heatlevel']) { ?>
<img src="template/elec_201706_bt/style/elecom_icon/hot_<?php echo $thread['heatlevel'];?>.gif" align="absmiddle" alt="heatlevel" title="热度: <?php echo $thread['heats'];?>" />
<?php } if($thread['rate'] > 0) { ?>
<img src="template/elec_201706_bt/style/elecom_icon/agree.gif" align="absmiddle" alt="agree" title="帖子被加分" />
<?php } elseif($thread['rate'] < 0) { ?>
<img src="template/elec_201706_bt/style/elecom_icon/disagree.gif" align="absmiddle" alt="disagree" title="帖子被减分" />
...
新窗口打开" target="_blank">
<?php if($thread['folder'] == 'lock') { ?>
<img src="template/elec_201706_bt/style/elecom_icon/folder_lock.gif" />
<?php } elseif($thread['special'] == 1) { ?>
<img src="template/elec_201706_bt/style/elecom_icon/pollsmall.gif" alt="投票" />
<?php } elseif($thread['special'] == 2) { ?>
<img src="template/elec_201706_bt/style/elecom_icon/tradesmall.gif" alt="商品" />
<?php } elseif($thread['special'] == 3) { ?>
<img src="template/elec_201706_bt/style/elecom_icon/rewardsmall.gif" alt="悬赏" />
<?php } elseif($thread['special'] == 4) { ?>
<img src="template/elec_201706_bt/style/elecom_icon/activitysmall.gif" alt="活动" />
<?php } elseif($thread['special'] == 5) { ?>
<img src="template/elec_201706_bt/style/elecom_icon/debatesmall.gif" alt="辩论" />
<?php } elseif(in_array($thread['displayorder'], array(1, 2, 3, 4))) { ?>
<img src="template/elec_201706_bt/style/elecom_icon/pin_<?php echo $thread['displayorder'];?>.gif" alt="<?php echo $_G['setting']['threadsticky'][3-$thread['displayorder']];?>" />
<?php } ?>
</a>
...
<?php if(!$_GET['archiveid']) { ?><a id="newspecialtmp" onClick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>')" href="javascript:;" title="发布新帖" style="margin: -8px 0 0 0;">发布新帖</a><?php } ?>
...
<div class="sd" style="float: right; width: 306px;">
...
<?php } ?>
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameF85ys3" class="frame move-span cl frame-1"><div id="frameF85ys3_left" class="column frame-1-c"><div id="frameF85ys3_left_temp" class="move-span temp"></div><?php block_display('149');?></div></div><div id="framel8e8sc" class="frame move-span cl frame-1"><div id="framel8e8sc_left" class="column frame-1-c"><div id="framel8e8sc_left_temp" class="move-span temp"></div><?php block_display('150');?></div></div></div><!--[/diy]-->
</div>
