...
0
|| checktplrefresh('data/diy/./template/elec_201706_bt//forum/viewthread.htm', './template/elec_201706_bt/forum/viewthread_node.htm', 1539883085, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/elec_201706_bt/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/elec_201706_bt//forum/viewthread.htm', './template/elec_201706_bt/forum/viewthread_fastpost.htm', 1539883085, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/elec_201706_bt/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/elec_201706_bt//forum/viewthread.htm', './template/elec_201706_bt/forum/viewthread_node_body.htm', 1539883085, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/elec_201706_bt/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/elec_201706_bt//forum/viewthread.htm', './template/default/common/seditor.htm', 1539883085, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/elec_201706_bt/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/elec_201706_bt//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1539883085, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/elec_201706_bt/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/elec_201706_bt//forum/viewthread.htm', './template/default/common/upload.htm', 1539883085, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/elec_201706_bt/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/elec_201706_bt//forum/viewthread.htm', './template/default/common/seccheck.htm', 1539883085, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/elec_201706_bt/', 'forum/viewthread')
;
block_get('153,151,152');?><?php include template('common/header'); $ucthread = C::t('forum_thread')->fetch_all_by_authorid($_G['forum_thread']['authorid'], 0,8);?><?php $ucauthor = DB::fetch_first("SELECT `follower`,`threads`,`following` FROM ".DB::table('common_member_count')." WHERE uid = ".$_G['forum_thread']['authorid']);?><link rel="stylesheet" type="text/css" id="time_diy" href="template/elec_201706_bt/style/css/index.css" />
...
<div id="ct" class="wp cl <?php if($close_leftinfo) { ?> ct2<?php } ?>">
    ...
    <div class="mn" <?php if(!$close_leftinfo) { ?> style="width:100%">
...
<?php } ?>
            ...
            <?php } ?>
            <?php } ?>
            <span class="xg1" <?php if($close_leftinfo) { ?>style="display: none;"<?php } ?>>
...
<div id="threadstamp"><img src="<?php echo STATICURL;?>image/stamp/<?php echo $_G['forum_threadstamp']['url'];?>" title="<?php echo $_G['forum_threadstamp']['text'];?>" <?php if($close_leftinfo) { ?>class="x"<?php } ?>></div>
...
<div class="pi <?php if($close_leftinfo && $post['first']) { ?>tpi<?php } ?>">
...
<?php } if($close_leftinfo) { ?><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="xi2" <?php if($post['first']) { ?>style="padding-left: 10px;"<?php } ?>><?php echo $post['author'];?></a><?php echo $authorverifys;?><?php } if($close_leftinfo) { } ?>
<em id="authorposton<?php echo $post['pid'];?>" style="margin-left: 10px;"><?php echo $post['dateline'];?></em>
...
<?php } if($close_leftinfo && $post['first']) { ?>
<span class="pl10" <?php if($close_leftinfo) { ?>style="display: none;"<?php } ?>>
<?php if($post['invisible'] == 0) { ?><a href="forum.php?mod=viewthread&amp;action=printable&amp;tid=<?php echo $_G['tid'];?>" title="打印" target="_blank"><img src="<?php echo IMGDIR;?>/print.png" alt="打印" class="vm" /></a>
<?php } ?>
<a href="forum.php?mod=redirect&amp;goto=nextoldset&amp;tid=<?php echo $_G['tid'];?>" title="上一主题"><img src="<?php echo IMGDIR;?>/thread-prev.png" alt="上一主题" class="vm" /></a>
<a href="forum.php?mod=redirect&amp;goto=nextnewset&amp;tid=<?php echo $_G['tid'];?>" title="下一主题"><img src="<?php echo IMGDIR;?>/thread-next.png" alt="下一主题" class="vm" /></a>
...
<?php if(!$close_leftinfo) { if($_G['setting']['allowfastreply'] && $post['first'] && $fastpost && $allowpostreply && !$_G['forum_thread']['archiveid'] && $_GET['from'] != 'preview') { ?>
...
<div class="rep_s cl">
    	<h2 class="z">大神点评<em style="display: none;"><?php echo $_G['forum_thread']['allreplies'];?></em></h2>
...
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_endline'][$postcount])) echo $_G['setting']['pluginhooks']['viewthread_endline'][$postcount];?>
    ...
    <div class="pgs mbm cl" style="margin-top: 20px;">
        ...
        <?php if(!$_G['forum_thread']['is_archived']) { ?>
            <a class="elec_pst_btn" <?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="发新帖">发表新帖</a>
        <?php } ?>
        <?php if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
            <a class="elec_rpl_btn" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复">回复</a>
        <?php } ?>
    ...
    <?php if($close_leftinfo) { ?><!--[diy=diyfastposttop]--><div id="diyfastposttop" class="area"><div id="framegmZ96h" class="frame move-span cl frame-1"><div id="framegmZ96h_left" class="column frame-1-c"><div id="framegmZ96h_left_temp" class="move-span temp"></div><?php block_display('153');?></div></div></div><!--[/diy]--><?php } ?>
    <?php if($fastpost) { ?>
        <script type="text/javascript">
...
<div id="f_pst" class="pl<?php if(empty($_GET['from'])) { ?> bm bmw<?php } ?>" <?php if($close_leftinfo) { ?>style="border: 0;"<?php } ?>>
...
<div class="clear"></div>
                <div class="elec_right_info" style="text-align: center">
                    <p class="" style="display: inline-block;"><span>关注</span><strong><?php echo $ucauthor['following'];?></strong></p>
                    <p class="" style="display: inline-block;"><span>粉丝</span><strong><?php echo $ucauthor['follower'];?></strong></p>
                    <p class="" style="display: inline-block;"><span>帖子</span><strong><?php echo $ucauthor['threads'];?></strong></p>
                    <div class="clear"></div>
           		</div>
...
<a class="elecfabu" onclick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>')" href="javascript:;" title="发新帖">发布主题</a>
        <!--[diy=diy01]--><div id="diy01" class="area"><div id="frameYMM48g" class="frame move-span cl frame-1"><div id="frameYMM48g_left" class="column frame-1-c"><div id="frameYMM48g_left_temp" class="move-span temp"></div><?php block_display('151');?></div></div><div id="frameQDPp6X" class="frame move-span cl frame-1"><div id="frameQDPp6X_left" class="column frame-1-c"><div id="frameQDPp6X_left_temp" class="move-span temp"></div><?php block_display('152');?></div></div></div><!--[/diy]-->
