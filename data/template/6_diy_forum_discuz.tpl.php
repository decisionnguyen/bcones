...
block_get('146,148,147');?><?php include template('common/header'); ?><script src="template/elec_201706_bt/style/js/jquery.superslide.js" type="text/javascript" type="text/javascript"></script>
<script src="template/elec_201706_bt/style/js/scroller.js" type="text/javascript" type="text/javascript"></script>
<link rel="stylesheet" type="text/css" id="time_diy" href="template/elec_201706_bt/style/css/index.css" />
<link rel="stylesheet" type="text/css" id="time_diy" href="template/elec_201706_bt/style/css/nanoscroller.css" />
...
<?php if(empty($gid)) { ?>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="framem0xggZ" class="frame move-span cl frame-1"><div id="framem0xggZ_left" class="column frame-1-c"><div id="framem0xggZ_left_temp" class="move-span temp"></div><?php block_display('146');?></div></div></div><!--[/diy]-->
</div>
<?php } ?>
...
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framePfnXVm" class="frame move-span cl frame-1"><div id="framePfnXVm_left" class="column frame-1-c"><div id="framePfnXVm_left_temp" class="move-span temp"></div><?php block_display('148');?></div></div><div id="framemXxERn" class="frame move-span cl frame-1"><div id="framemXxERn_left" class="column frame-1-c"><div id="framemXxERn_left_temp" class="move-span temp"></div><?php block_display('147');?></div></div></div><!--[/diy]-->
</div>
            <script type="text/javascript">
jQuery.noConflict();
