...
$server_url = 'action=plugins&operation=config&do=' . $pluginid . '&identifier=csdn123com_toutiao&pmod=reg_user';
if ($_GET['formhash'] == FORMHASH && empty($_GET['adduser']) == false && $_GET['adduser'] == 'yes') {
	...
	cpmsg("csdn123com_toutiao:reguser_num_ok", $server_url, "succeed");
	...
	include template('csdn123com_toutiao:reg_user');
